...
class TTextTheme {
  ...
  /// Customizable Light Text Theme[Kişiselleştirilebilir Açık Metin Teması]
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall:
        const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.5)),
  ...
  /// Customizable Dark Text Theme[Kişiselleştirilebilir Koyu Metin Teması]
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall:
        const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.5)),
